...
function _Datepicker(props: IDatepickerProps) {
	...
	const _selectedDate = clone(props.defaultDate);
	...
	const language = "idn";
	const [properties, setProperties] = useState(calculateProperties(defaultDate));
	const [selectedMonth, setSelectedMonth] = useState(
		props.selectedMonth ? props.selectedMonth : getMonth(new Date(defaultDate as any))
	);
	const [selectedYear, setSelectedYear] = useState(
		props.selectedYear ? props.selectedYear : getYear(new Date(defaultDate as any))
	);
	...
	useEffect(() => {
		...
		if (!isSameMonth(currentSelectedMonth, selectedDate) && isDate(selectedDate)) {
	...
	return (
		<Container style={style}>
			<DatepickerHeader {...{ title, selectedMonth, selectedYear, language, changeDisplay }} />
			<Days
				{...{
