...
import useIsTrackEnabled from '../../../../data/hooks/use-isTrackEnabled';
import useMediaStreamTrack from '../../../../data/hooks/use-mediaStreamTrack';
...
function AudioLevelIndicator({ audioTrack, color = 'white' }: { audioTrack?: AudioTrack; color?: string }) {
	...
	return isTrackEnabled ? (
		<svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 24 24" data-test-audio-indicator>
			<defs>
